"""
Django settings for denmark project.
...
SECRET_KEY = 'django-insecure-q8*&cnr2*7@jut%=7)_k_^0i2j)z$)*_^#3=cja6prta&o9p_v'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["*", '16.170.237.49', 'denmarkgov.com', 'www.denmarkgov.com']
...
WSGI_APPLICATION = 'denmark.wsgi.application'
